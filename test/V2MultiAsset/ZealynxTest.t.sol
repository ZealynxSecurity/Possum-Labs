...
//         uint256 withdrawShares = (USDC_WATER).convertToShares(fuzzAmount);
//         uint256 grossReceived = (USDC_WATER).convertToAssets(
//             withdrawShares
//         );
//         uint256 denominator = (USDC_WATER).DENOMINATOR();
//         uint256 fees = (grossReceived * (USDC_WATER).withdrawalFees()) /
//             denominator;
...
//         // UNSTAKE //
//         uint256 balanceBefore = Alice.balance;
//         uint256 withdrawShares = (WETH_WATER).convertToShares(fuzzAmount);
//         uint256 grossReceived = (WETH_WATER).convertToAssets(
//             withdrawShares
//         );
//         uint256 denominator = (WETH_WATER).DENOMINATOR();
//         uint256 fees = (grossReceived * (WETH_WATER).withdrawalFees()) /
//             denominator;
//         uint256 netReceived = grossReceived - fees;
...
//          uint256 balanceBefore = usdc.balanceOf(Alice);
//         uint256 withdrawShares = (USDC_WATER).convertToShares(amount);
//         uint256 grossReceived = (USDC_WATER).convertToAssets(
//             withdrawShares
//         );
//         uint256 denominator = (USDC_WATER).DENOMINATOR();
